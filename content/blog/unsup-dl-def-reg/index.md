...
![Performance Ranking](fig-4.png)\
**Fig. 4**: Boxplot showing percentages that the alternative algorithms were ranked “best” by 3 practicing interventional neuroradiologists. Red circles represent the means. Reg-VLE is significantly better than Reg-MinMax (P = .037), Reg-MSE (P = .0027), and DSA (P = .00030). Reg-MinMax is significantly better than DSA (P = .0073). Abbreviation: DSA = digital subtraction angiography.
